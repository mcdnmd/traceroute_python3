...
class IP:
    ...
    def parse(self, data):
        ...
        self.header.dont_fragment_flag = (ip_header[4] >> 13) & 2
    ...
    def create_ip_header(self, src, dst, ttl):
        ...
        self.header.dont_fragment_flag = 0
        self.header.more_fragments_flag = 0
        self.header.offset = 0
        self.header.ttl = ttl
        self.header.protocol = 17
    ...
    def pack(self):
        ...
        result = struct.pack('!BBHHHBBH4s4s',
                             version_ihl,
                             dscp_ecn,
                             self.header.total_length,
                             int(self.header.id, 16),
                             flags_offset,
                             self.header.ttl,
